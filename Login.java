...
public class Login extends JFrame
{
	...
	static final String DB_URL = "jdbc:mysql://localhost/quizapp?verifyServerCertificate=false&useSSL=true";
	...
	{	
		...
		label2.setText("Effort=Marks  --Rajaram gowda");
				...
				if (username.equals("")|| password.equals(""))
				{
				...
				else  
                   {
					...
					try {
			            ...
			            Connection con = DriverManager.getConnection("jdbc:mysql://localhost/quizapp?verifyServerCertificate=false&useSSL=true", "root", PASS);
			            Statement stmt = (Statement) con.createStatement();
			           String query = "SELECT user_name, passwd FROM quiz;";
